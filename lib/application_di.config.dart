...
import 'package:musicday_mobile/auth/di/auth_module.dart' as _i19;
...
import 'package:musicday_mobile/auth/interactors/sign_up_interactor_impl.dart'
    as _i18;
import 'package:musicday_mobile/auth/network/auth_remote_service.dart' as _i13;
...
import 'package:musicday_mobile/auth/repositories/auth_session_repository_impl.dart'
    as _i15;
import 'package:musicday_mobile/auth/ui/intro/intro_screen_bloc.dart' as _i11;
...
import 'package:musicday_mobile/core/network/di/network_module.dart' as _i20;
import 'package:musicday_mobile/core/storage/di/storage_module.dart' as _i21;
...
_i1.GetIt init(
  ...
  gh.factory<_i7.SignUpScreenBloc>(
      () => _i7.SignUpScreenBloc(signUpInteractor: gh<_i8.SignUpInteractor>()));
  gh.singleton<_i9.Validator<String>>(
    _i10.NameValidator(loggerFactory: gh<_i5.LoggerFactory>()),
    instanceName: 'nameValidator',
  );
  gh.factory<_i11.IntroScreenBloc>(() => _i11.IntroScreenBloc(
        loggerFactory: gh<_i5.LoggerFactory>(),
        googleSignInInteractor: gh<_i12.GoogleSignInInteractor>(),
      ));
  return getIt;
...
_i1.GetIt initAuthScope(
  ...
  return _i2.GetItHelper(getIt).initScope(
    ...
    init: (_i2.GetItHelper gh) {
      ...
      gh.factory<_i13.AuthRemoteService>(
          () => authModule.provideAuthRemoteService(gh<_i3.Dio>()));
      gh.singleton<_i14.AuthSessionRepository>(_i15.AuthSessionRepositoryImpl(
        loggerFactory: gh<_i5.LoggerFactory>(),
        flutterSecureStorage: gh<_i4.FlutterSecureStorage>(),
      ));
      gh.singleton<_i16.GoogleSignIn>(authModule.provideGoogleSignIn());
      gh.singleton<_i12.GoogleSignInInteractor>(_i17.GoogleSignInInteractorImpl(
        loggerFactory: gh<_i5.LoggerFactory>(),
        authSessionRepository: gh<_i14.AuthSessionRepository>(),
        authRemoteService: gh<_i13.AuthRemoteService>(),
        googleSignIn: gh<_i16.GoogleSignIn>(),
      ));
      gh.singleton<_i8.SignUpInteractor>(_i18.SignUpInteractorImpl(
        nicknameValidator:
